...
instance (Typed a) => Typed (Statement a) where
    ...
    typ (DataAssStmt  a _ _   ) = typ a
    typ (DataAddStmt  a _ _   ) = typ a
    typ (DataSubStmt  a _ _   ) = typ a
    typ (DataMulStmt  a _ _   ) = typ a
    typ (DataDivStmt  a _ _   ) = typ a
    typ (DataPowStmt  a _ _   ) = typ a
    typ (DataCompStmt a _ _   ) = typ a
